      ...
      <div className="flex items-end justify-between">
        ...
        <div className="flex items-center gap-2">
          {metricKey === 'conversionRate' && numericValue !== undefined && numericValue > 100 && (
            <span className={`text-[10px] px-2 py-0.5 rounded-full border ${isDarkMode ? 'border-purple-700 text-purple-200 bg-purple-900/30' : 'border-purple-200 text-purple-700 bg-purple-50'}`}>
