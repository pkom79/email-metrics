        ...
        <article className="relative">
            <header className="mb-10">
                ...
                <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 max-w-2xl leading-relaxed">
                    To ensure Email Metrics processes your data correctly, you’ll need to prepare and export your Klaviyo CSV files exactly as outlined below. We use CSV uploads instead of an API connection because CSV handles large data sets faster and with fewer errors. For most accounts, the entire export and upload process takes under 3 minutes.
                </p>
            </header>
            ...
            <Step num={2} title="Create a Segment of All Active Subscribers">
                ...
                <div className="mt-3">
                    <img src="/brand/exports_tutorial/subscribers_create_segment.png" alt="Creating a new subscribers segment in Klaviyo" className={imgCls} loading="lazy" />
                </div>
            ...
            <Step num={3} title="Export the Segment">
                <ol className="list-decimal pl-5 space-y-2">
                    ...
                    <li>
                        From inside the Segment page, go to <strong>Manage Segment → Export Segment to CSV</strong>.
                        <div className="mt-2">
                            <img src="/brand/exports_tutorial/susbcribers_export_segment_to_csv.png" alt="Export segment to CSV in Klaviyo" className={imgCls} loading="lazy" />
                        </div>
                    </li>
                    <li>
                        On the Export Review screen, check <strong>Property</strong> to select all fields.
                        <div className="mt-2">
                            <img src="/brand/exports_tutorial/subscribers_export_review.png" alt="Export review screen checking properties" className={imgCls} loading="lazy" />
                        </div>
                    </li>
            ...
            <Step num={4} title="Save the Exported File">
                <ul className="list-disc pl-5 space-y-2">
                    ...
                    <li>
                        If not prompted, go to <strong>Manage Segment → View My Exports</strong>.
                        <div className="mt-2">
                            <img src="/brand/exports_tutorial/subscribers_view_my_exports.png" alt="Viewing segment exports in Klaviyo" className={imgCls} loading="lazy" />
                        </div>
                    </li>
                    <li>
                        Download the file from the list of completed exports.
                        <div className="mt-2">
                            <img src="/brand/exports_tutorial/susbcribers_download.png" alt="Downloading subscribers CSV export" className={imgCls} loading="lazy" />
                        </div>
                    </li>
                </ul>
            ...
            <Step num={5} title="Export Flow Analytics">
                <ol className="list-decimal pl-5 space-y-2">
                    ...
                    <li>
                        Open <strong>Options → Export analytics</strong>.
                        <div className="mt-2">
                            <img src="/brand/exports_tutorial/flows_export_analytics.png" alt="Export analytics option for flows" className={imgCls} loading="lazy" />
                        </div>
                    </li>
                    ...
                    <li>
                        Click <strong>Export Analytics</strong>.
                        <div className="mt-2">
                            <img src="/brand/exports_tutorial/flows_export_flow_analytics.png" alt="Flow analytics export window" className={imgCls} loading="lazy" />
                        </div>
                    </li>
            ...
            <Step num={6} title="Export Campaign Analytics">
                <ol className="list-decimal pl-5 space-y-2">
                    ...
                    <li>
                        Click the three-dot menu (⋮) next to <strong>View Library → Export analytics</strong>.
                        <div className="mt-2">
                            <img src="/brand/exports_tutorial/campaigns_export_analytics.png" alt="Export analytics menu for campaigns" className={imgCls} loading="lazy" />
                        </div>
                    </li>
                    ...
                    <li>
                        Click <strong>Export Analytics</strong>.
                        <div className="mt-2">
                            <img src="/brand/exports_tutorial/campaigns_export_campaign_analytics.png" alt="Campaign analytics export window" className={imgCls} loading="lazy" />
                        </div>
                    </li>
            ...
            <footer className="mt-16 pt-8 border-t border-gray-200 dark:border-gray-800 text-xs text-gray-500 dark:text-gray-400">
                <p>Need help? Reach out via support and include any questions about your export.</p>
            </footer>
        </article>
    );
}
